      ...
      <div className="flex border-b border-gray-200 mb-6 gap-8">
        <button
          ...
          className={`flex items-center gap-2 pb-4 text-sm font-medium transition-colors relative ${
            activeTab === 'base' ? 'text-blue-600' : 'text-gray-500 hover:text-gray-700'
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 pb-4 text-sm font-medium transition-colors relative ${
            activeTab === 'visual' ? 'text-blue-600' : 'text-gray-500 hover:text-gray-700'
          }`}
        >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div 
                    ...
                    className={`aspect-square border-2 border-dashed rounded-lg flex flex-col items-center justify-center cursor-pointer transition-colors overflow-hidden ${
                      draft?.base_image ? 'border-blue-200 bg-blue-50' : 'border-gray-300 hover:border-blue-400'
                    }`}
                  >
                    {draft?.base_image ? (
                ...
                <div className="space-y-2">
                  ...
                  <div 
                    ...
                    className={`aspect-square border-2 border-dashed rounded-lg flex flex-col items-center justify-center cursor-pointer transition-colors overflow-hidden ${
                      draft?.mask_image ? 'border-purple-200 bg-purple-50' : 'border-gray-300 hover:border-blue-400'
                    }`}
                  >
                    {draft?.mask_image ? (
