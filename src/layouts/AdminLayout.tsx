      ...
      <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 z-30">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-lg flex items-center gap-2">
            管理後台 <span className="text-xs font-normal bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full">V3.4</span>
          </span>
        </div>
      ...
      `}>
        ...
        <div className="p-4 border-t border-gray-200 space-y-2">
          ...
          <div className="px-4 py-2 mt-4 text-center">
            <span className="text-xs text-gray-400 font-medium">Version 3.4</span>
          </div>
        </div>
      </aside>
