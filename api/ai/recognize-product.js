...
【重要：罕見漢字辨識提示】
以下為常出現於商品規格的特殊金屬材質字，請特別注意筆畫，不可以形似字替換：
- 「鈦」(tài) — 金属＋台，正確字為「鈦」，常見詞：沙漠鈦金、鈦原色。絕對不能寫成「鉻」「洛」「鎖」「鏡」等相似字。
- 「鉻」(gè) — 金属＋各，正確字為「鉻」，是完全不同的材質。
- 「矽」(xì) — 矢＋夕，用於矽膠殼。
若圖片中某字你不確定讀음，請對照下方已知顏色選項選出最接近的：
沙漠鈦金 / 迷霧黑 / 銀白 / 鈦原色 / 太空灰 / 星光金 / 深藍黑 / 玫瑰金 / 古銅金 / 暗夜綠`;
